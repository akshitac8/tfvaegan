...
os.system('''CUDA_VISIBLE_DEVICES=0 OMP_NUM_THREADS=4 python train_actions.py --encoded_noise --gzsl_od --nclass_all 51 \
--dataroot datasets --manualSeed 806 --syn_num 1200 --preprocessing --cuda --gammaD 10 --gammaG 10 \
